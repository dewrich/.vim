" Plug {
    ...
    Plug 'dewrich/L9'
    Plug 'dewrich/ack'
    Plug 'dewrich/indentpython'
    Plug 'dewrich/syntastic'
    ...
    Plug 'golang/lint'
    "Plug 'git://github.com/Lokaltog/powerline'
    Plug 'bling/vim-airline'
    Plug 'dewrich/vim-easygrep'
    Plug 'rdunklau/vim-perltidy'
    Plug 'tpope/vim-rbenv'
    Plug 'michalliu/sourcebeautify.vim'
    Plug 'vim-scripts/perlprove.vim'
	...
	"Plug 'git://github.com/davidpthomas/vim4rally'
	...
	"Plug 'git://github.com/farazdagi/vim-go-ide'
	"Plug 'git://github.com/dgryski/vim-godef'
	"Plug 'git://github.com/lrvick/Conque-Shell'
